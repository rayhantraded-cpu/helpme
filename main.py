...
# ==========================================
# 1. محرك قاعدة البيانات (SQLite) - النسخة الناجحة
# ==========================================
...
def main(page: ft.Page):
    ...
    def save_new_task(e):
        ...
        page.open(ft.SnackBar(content=ft.Text("تم حفظ المهمة في قاعدة البيانات بنجاح!")))
    ...
    main_layout = ft.Container(
        content=ft.Column([motivation_header, tabs, bottom_navigation_bar], spacing=0, expand=True),
        expand=True,
